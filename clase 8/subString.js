// un sistema de gestion de pedidos recibe codigos de seguimiento en el formato: PED-2025-00045,Se necesita extraer al año del pedido y el número de pedido y el numero de orden usando el metodo substring().
//Requisitos:
